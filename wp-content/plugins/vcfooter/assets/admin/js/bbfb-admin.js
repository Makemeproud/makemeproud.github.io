...
$( document ).ready(function(){
    if($("body").hasClass("post-type-bbfb_content")){
        $('html.wp-toolbar').addClass('wpsg_active');
        var html = '<div class="wpsg_raiting">Enjoyed <b>Ultimate Footer Builder</b>? Please leave us a <div class="wpsg_content_star">';
            ...
            html += ' <a href="https://1.envato.market/19999967" target="_blank" class="wpsg_star_4 fa fa-star" title = "Good"></a>';
            html += ' <a href="https://1.envato.market/19999967" target="_blank" class="wpsg_star_5 fa fa-star" title = "Very good"></a>';
