...
if ( ! class_exists( 'BESTBUG_HB_CONTACT_SHORTCODE' ) ) {
	/**
	 * BESTBUG_HB_CONTACT_SHORTCODE Class
	 *
	 * @since	1.0
	 */
	class BESTBUG_HB_CONTACT_SHORTCODE {
		...
		public function init() {
			...
			add_shortcode( BESTBUG_HB_CONTACT_SHORTCODE, array( $this, 'shortcode' ) );
		...
		public function vc_shortcode() {
			...
			vc_map( array(
			    "name" => esc_html__( "Contact Form", 'bestbug' ),
			    "base" => BESTBUG_HB_CONTACT_SHORTCODE,
			    "as_parent" => array('except' => BESTBUG_HB_CONTACT_SHORTCODE),
			    "content_element" => true,
				"icon" => 'bbhd_icon_contact',
		...
		public function settings($attr = BESTBUG_HB_CONTACT_SHORTCODE) {
			return BESTBUG_HB_CONTACT_SHORTCODE;
		}
		...
		public function shortcode( $atts ){
			...
			$class_string = apply_filters( 'vc_shortcodes_css_class', implode(' ', $class_array), BESTBUG_HB_CONTACT_SHORTCODE, $atts );
	...
	new BESTBUG_HB_CONTACT_SHORTCODE();
}
